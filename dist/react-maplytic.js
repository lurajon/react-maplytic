(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tty'), require('util'), require('url'), require('http'), require('https'), require('assert'), require('stream'), require('zlib')) :
	typeof define === 'function' && define.amd ? define(['exports', 'tty', 'util', 'url', 'http', 'https', 'assert', 'stream', 'zlib'], factory) :
	(factory((global['@lurajon/react-maplytic'] = {}),global.tty,global.util,global.url,global.http,global.https,global.assert,global.stream,global.zlib));
}(this, (function (exports,tty,util,url,http,https,assert,stream,zlib) { 'use strict';
