(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tty'), require('util'), require('url'), require('http'), require('https'), require('assert'), require('stream'), require('zlib'), require('react')) :
	typeof define === 'function' && define.amd ? define(['exports', 'tty', 'util', 'url', 'http', 'https', 'assert', 'stream', 'zlib', 'react'], factory) :
	(factory((global['@lurajon/react-maplytic'] = {}),global.tty,global.util,global.url,global.http,global.https,global.assert,global.stream,global.zlib,global.React));
}(this, (function (exports,tty,util,url,http,https,assert,stream,zlib,React) { 'use strict';
...
var _where = "/Users/jonelura/projects/react-maplytic";
var author = {
	name: "Matt Zabriskie"
};
var browser$1 = {
